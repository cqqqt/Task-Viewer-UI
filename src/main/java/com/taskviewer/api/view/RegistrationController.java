...
public class RegistrationController implements Initializable {
    ...
    void handleRegistration(ActionEvent event) {
        ...
        try {
            ...
            sendPOSTRequest(host + "/api/v1/auth/register", "{\"username\":\"" + username + "\",\"password\":\"" + password + "\",\"email\":\"" + email + "\",\"firstname\":\"" + firstName + "\",\"lastname\":\"" + lastName + "\"}");
    ...
    private String sendPOSTRequest(String url, String body) throws IOException {
        ...
        String errMessage = connection.getResponseMessage();
        if (statusCode == HttpURLConnection.HTTP_CREATED) {
            ...
            throw new IOException("Ошибка: " + statusCode + ". Сообщение: " + errMessage);
        }
    }
}
